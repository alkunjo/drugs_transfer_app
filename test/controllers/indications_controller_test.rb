...
class IndicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create indication" do
    assert_difference('Indication.count') do
      post indications_url, params: { indication: { indication_name: @indication.indication_name } }
    end
  ...
  test "should update indication" do
    patch indication_url(@indication), params: { indication: { indication_name: @indication.indication_name } }
