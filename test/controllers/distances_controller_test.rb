...
class DistancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distance" do
    assert_difference('Distance.count') do
      post distances_url, params: { distance: { destination_id: @distance.destination_id, distance: @distance.distance, origin_id: @distance.origin_id } }
    end
  ...
  test "should update distance" do
    patch distance_url(@distance), params: { distance: { destination_id: @distance.destination_id, distance: @distance.distance, origin_id: @distance.origin_id } }
